...
let currentVideoIndex = 17;

    function playVideo() {
        if (currentVideoIndex >= 29) {
            document.getElementsByClassName("button2")[0].innerHTML = "RATE YOUR DISH";
        ...
        headerElement.innerHTML = `Chips and Salsa: ${videoArray[currentVideoIndex].title}`;
    ...
    function startTimer(durationInMinutes) 
    {
        ...
        const timerElement = document.getElementById("timer"); //Timer code learned from Stack Overflow: https://stackoverflow.com/questions/31559469/how-to-create-a-simple-javascript-timer 
